...
import { mfaSetupQueryFn, MfaType, mfaVerifyMutationFn } from "@/lib/api";
import { Skeleton } from "@/components/ui/skeleton";
import { toast } from "sonner";
import RevokeMfa from "./_common/revoke";
        ...
        <RevokeMfa />
          ...
          <Dialog modal open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
              <Button disabled={isLoading} className="h-[35px] dark:text-gray-900">
                Enable MFA
              </Button>
            </DialogTrigger>
                ...
                {showKey ? (
                  <div className="w-full">
                    ...
                    >
                      ...
                      <button disabled={copy} onClick={() => onCopy(mfaData?.qrCode)}>
                        {copy ? (
